...
```
cd existing_repo
git remote add origin https://gitlab.com/wallet-wise/discovery-server.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/wallet-wise/discovery-server/-/settings/integrations)
